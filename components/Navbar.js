const Navbar = (props) => {
  ...
  const moon = (
    <svg
      className='fill-lm-color2 hover:fill-lm-color7'
      width='20'
      height='20'
  ...
  const sun = (
    <svg
      className='fill-dm-color2 hover:fill-dm-color-5'
      width='20'
      height='20'
      xmlns='http://www.w3.org/2000/svg'
    >
  ...
  return (
    <nav className='flex justify-between items-center mb-12'>
      ...
      <div
        ...
        onClick={handleClick}
      >
        <p className='text-lm-color-2 font-bold text-xs tracking-widest dark:text-dm-color2 uppercase'>
          {props.darkMode === '' ? 'dark' : 'light'}
        </p>
        {props.darkMode === '' ? moon : sun}
        {/* <svg
          className='fill-dm-color2'
          width='20'
          height='20'
          xmlns='http://www.w3.org/2000/svg'
        >
